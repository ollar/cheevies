...
exports.onAddCheevie = functions.database.ref('/users/{userId}/cheevies/{cheevieId}').onCreate(event => {
  ...
  const getCheeviePromise = admin.database().ref(`/cheevies/${cheevieId}`).once('value');
